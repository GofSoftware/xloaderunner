...
describe('TileMap', () => {
  ...
  it('should not treat crossbar, lava, or player-start tiles as solid ground', () => {
  ...
  it('should only treat brick tiles as walls, not stairs, crossbars, lava, player-start, or empty cells', () => {
    tileMap.setTile(1, 3, TileType.Brick);
  ...
  it('should only treat lava tiles as dangerous, not brick, stairs, crossbar, player-start, or empty cells', () => {
